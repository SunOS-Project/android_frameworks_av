...
public:
    ...
    static status_t setAppVolume(const String8& packageName, const int uid, const float value);
    static status_t setAppMute(const String8& packageName, const int uid, const bool mute);
