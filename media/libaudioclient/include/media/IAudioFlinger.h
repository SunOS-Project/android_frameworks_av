...
public:
    ...
    virtual status_t setAppVolume(const String8& packageName, const int uid, const float value) = 0;
    virtual status_t setAppMute(const String8& packageName, const int uid, const bool mute) = 0;
...
public:
    ...
    status_t setAppVolume(const String8& packageName, const int uid, const float value) override;
    status_t setAppMute(const String8& packageName, const int uid, const bool mute) override;
...
public:
    ...
    Status setAppVolume(const std::string& packageName, const int uid, const float value) override;
    Status setAppMute(const std::string& packageName, const int uid, const bool mute) override;
